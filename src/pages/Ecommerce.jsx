...
import { GoDotFill } from 'react-icons/go'; //GoPrimitiveDot is removed
      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item) => (
            <div key={item.title} className="bg-white h-44 dark:text-gray dark:bg-secondary-dark-bg md:w-56  p-4 pt-9 rounded-2xl ">
              <button
                type="button"
